...
public class AnimalResourceRestService {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response createMember(Animal animal) {

		Response.ResponseBuilder builder = null;

		try {
			// Validates member using bean validation
			validateMember(animal);
	 ...
	 */
	private void validateMember(Animal animal) throws ConstraintViolationException, ValidationException {
		...
		if (nameAlreadyExists(animal.getName())) {
